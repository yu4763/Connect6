...
int checkopponent(int s[19][19], char state, int& pos1, int& pos2, int p, int q, int found) {
				...
				if (cnt == 5) {
					if (empty > 1 || (empty == 1 && !left)) {
						if ((i + t < stoneNum) && (k + t < stoneNum) && s[i + t][k + t] == 0) {
                            ...
                            if(found==1){
                                pos2 = (i + emindex)*stoneNum + k + emindex;
                                return 2;
                            }
                            else{
                                pos1 = (i + emindex)*stoneNum + k + emindex;
	...
	checkopponentblank(s, state, pos1, pos2, p, q, found);

}

int checkopponentblank(int s[19][19], char state, int& pos1, int& pos2, int p, int q, int found) {
